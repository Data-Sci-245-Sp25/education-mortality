...
```
<p>Further looking at this correlation stratified by cancer type, we see that lung cancer has a much stronger correlation (R^2=.601) compared to the other cancer types. Additionally, breast cancer has a notably lower correlation (R^2=.1195). Ultimately, we see that lung cancer mortality rates are more affected by education level than breast cancer mortality rates. One potential reason for this is that those with a lower education are more likely to work blue-collar jobs that expose you to harmful pollutants and thus increase risk of lung cancer. Additionally, looking at the fact that most cases of breast cancer occur in women, we see less of an influence of education because women with lower education status are potentially not working as dangerous blue-collar jobs as their male counterparts. Also, breast cancer occurs more genetically. </p>
```{r echo=FALSE, message=FALSE}
educCancerRatesOverall$ddeduc <- as.numeric(educCancerRatesOverall$ddeduc)
